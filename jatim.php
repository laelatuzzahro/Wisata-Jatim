...
<html lang="en">
  ...
  <head>
    ...
    <title>Sejarah Jawa Timur</title>
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-lg-8">
          ...
          <h1 class="mt-4">Sejarah Jawa Timur</h1>
          ...
          <br> Sumber : Buku Peringatan Hari Jadi Ke -70 Provinsi Jawa Timur</p>
        ...
        <div class="col-md-4" >
          ...
          <!-- Side Widget -->
          <div class="card my-4">
            <h5 class="card-header">Kabupaten/Kota di Jawa Timur</h5>
            <div class="card-body">
             <img src="jatimm.jpg" width="300px" height="180px"></td>
            </div>
          </div>
          <!-- Side Widget -->
          <div class="card my-4">
            <h5 class="card-header">Pemimpin Jawa Timur</h5>
            <div class="card-body">
             <img src="gubernur.jpg" width="300px" height="180px"></td>
            <table>
             <tr>
              <td>Gubernur</td>
              <td>:</td> 
              <td>Dra. Hj. Khofifah Indar P.</td>
            </tr>
            <td> Wakil </td>
            <td>:</td>
             <td>Dr. Emil E. Darda, M.Sc </td>
             </table>
            </div>
          </div>
      ...
      <!-- Side Widget -->
          <div class="card my-4">
            <h5 class="card-header">Lagu daerah Jawa Timur</h5>
            <div class="card-body">
             <iframe width="300" height="180" src="https://www.youtube.com/embed/QOgxHhsY37E" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            </div>
          </div>
        </div>
