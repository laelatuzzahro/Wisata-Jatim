...
<html lang="en">
  ...
  <head>
    ...
    <title>Wisata Sejarah/Candi</title>
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
      <div class="container">
        <a class="navbar-brand" href="#">Monumen Bersejarah di Jawa Timur</a>
      ...
      <div class="row">
        ...
        <div class="col-md-8">
          ...
          <?php
            ...
            $query = mysqli_query($konek,"Select * from data where kategori='monumen'");
            while ($artikel = mysqli_fetch_array($query)) {
        
              ?>
           <div class="card mb-4">
            <img class="card-img-top" src="<?php echo $artikel['gambar'];?>" alt="Card image cap" width="750px" height="300px">
            <div class="card-body">
